...
<div>
<div style="word-wrap: break-word; -webkit-nbsp-mode: space; -webkit-line-break: after-white-space;"><div>Stay grounded.</div><div><br clear="none"/></div><div>3C beats Wyvern (low profiles).</div><div>6B can CH Wyvern to blow opponent back to full-screen.</div><div><br clear="none"/></div><div>Check for crouching (he is charging his DP while in this state).</div><div><br/></div><div><u>Netplayers</u></div><div><ul><li>SSJurgen</li></ul></div></div>
</div>
<hr>
<a name="512"/>
<h1>[Matchup] Rachel vs. Azrael</h1>
<div>
<table bgcolor="#D4DDE5" border="0">
<tr><td><b>Created:</b></td><td><i>3/12/2014 3:19 PM</i></td></tr>
<tr><td><b>Updated:</b></td><td><i>5/19/2014 2:06 PM</i></td></tr>
<tr><td><b>Tags:</b></td><td><i>azrael, bbcp, matchup, rachel</i></td></tr>
</table>
</div>
<br/>

<div>
<div><div><strong>Flow of the match revolves around how Azrael handles George.</strong></div><div><br clear="none"/></div><div><span style="text-decoration: underline;">Gustaff (his + on block Hell's Fang)</span></div><div><ul><li>Counter Hit 6B is your answer</li></ul></div><p><span style="text-decoration: underline;">Growler (his reversal that absorbs projectiles)</span></p><ul><li>If baited, can punish with 5C Fatal Counter!</li><li>He can store up to 3 fireballs.</li></ul><div><span style="text-decoration: underline;">Rachel setplay</span>     </div><div><ul><li>After 3C knockdown:</li><li style="list-style: none; display: inline"><ul><li>safest -&gt; pumpkin into either 5D or delay to catch backdash</li><li>frog -&gt; check for Growler timings with defending or backing off</li><li>in the corner -&gt; go for burst safe routes into knockdowns.</li><li style="list-style: none; display: inline"><ul><li>With full wind stock -&gt; 5B &gt; 5C(D)C &gt; 5B &gt; 6A &gt; 236A &gt; dash 5B &gt; jc &gt; j.C &gt; j.236A &gt; j.2D &gt; [5B &gt; jc &gt; j.C &gt; j.236A &gt; j.2D] x 2 &gt; 6A &gt; BBL &gt; 3C &gt; frog/pumpkin/gimmick</li></ul></li></ul></li></ul><div><span style="text-decoration: underline;">Netplayers</span></div><div><ul><li>SSJurgen</li><li>Takanub</li><li>grant-sama<ul><li>Where did I lose HP?<ul><li>Trying to 2A/5A out of pressure / mashing incorrectly</li><li>teleport cross-up &gt; throw</li><li>teleport cross-up &gt; sentinel dump re-cross-up</li><li>growler gives him a projectile....</li><li>impatience from fullscreen -- no need to rush in since zoning is more advantageous for Rachel</li></ul></li></ul></li></ul></div></div></div>
</div>
<hr>
<a name="514"/>
<h1>[Matchup] Rachel vs. Valkenhayn</h1>
<div>
<table bgcolor="#D4DDE5" border="0">
<tr><td><b>Created:</b></td><td><i>3/13/2014 5:22 AM</i></td></tr>
<tr><td><b>Updated:</b></td><td><i>5/19/2014 2:06 PM</i></td></tr>
<tr><td><b>Tags:</b></td><td><i>bbcp, matchup, rachel, valkenhayn</i></td></tr>
</table>
</div>
<br/>

<div>
<div style="word-wrap: break-word; -webkit-nbsp-mode: space; -webkit-line-break: after-white-space;"><div><u>Overview</u></div><ul><li>Game of on point zoning for Rachel. </li><li>In wolf form he can easily use his movement to force whiff lobelia shots.</li><li>Try to keep the match full-screen, opting to setup obstacle course over trying to win with pure normals (difficult).</li><li>Corner carry ASAP.</li></ul><div><u>Valkenhayn &quot;Tricks&quot;</u></div><div><ul><li>In wolf he can create instant overheads (j.A) or mix it up with empty wolf dash into low. Or... he can do double overhead. </li><li>With meter he can do the MITSURU instant overhead (j.C &gt; RC &gt; falling j.C).</li></ul><div><u>Notable netplayers</u></div></div><div><ul><li><b>ryota323</b> (or some number similar to that I don't recall)</li></ul></div></div>
</div>
<hr>
<a name="832"/>
<h1>[Matchup] Rachel vs. Rachel</h1>
<div>
<table bgcolor="#D4DDE5" border="0">
...
<div><div style="word-wrap: break-word; -webkit-nbsp-mode: space; -webkit-line-break: after-white-space;"><div>Bait wakeup Drive (guardpoint). <div><br/></div> If aggro Bang, 2C and note reactions.</div></div>
</div>
<hr>
<a name="1773"/>
